...
<div class="container">
	...
	<br><br><br><h2>New&nbspRequests</h2>
	<?php
		...
		echo "</table>";
                ?>
                  <form method="post">
                   <button type="submit" name="submit1" style="background-color: #101010ed; color: red; font-weight: 600; font-size: 18px;" class="btn btn-default"><span style="color: red;" class="glyphicon glyphicon-remove-sign"></span>&nbsp Remove</button>
