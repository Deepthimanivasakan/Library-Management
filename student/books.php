...
<body>
    <?php
     $b=mysqli_query($db,"SELECT * FROM `books` ORDER BY `books`.`bcount`  DESC LIMIT 0,2;");  
     ?>
    
    <div style="background-color: red; width: 100%; height: 50px; margin-top: -20px;">
...
function closeNav() {
  ...
  document.body.style.backgroundColor = "white";
    ...
    <!----____________________________________________search bar_______________________________________--->
  <form class="radio-btn-search" method="post" name="form1">
    <fieldset>
          <label>Search By:</label>
            <div>
                <input type="radio" id="keyword" name="drone" value="keyword" checked>
                <label for="keyword">Keyword</label>
                <input type="radio" id="title" name="drone" value="tilte">
                <label for="content">Title</label>
                <input type="radio" id="author" name="drone" value="author">
