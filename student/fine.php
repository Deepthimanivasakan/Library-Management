...
<body>
  ...
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
         <div style="color:white; font-size:24px; margin-left:40px;">
                    <?php
             if(isset($_SESSION['login_user']))
             {
                    echo "&nbsp; &nbsp;  &nbsp;<img class='img-circle profile_img' height=60 width=60 src='images/".$_SESSION['pic']."'><br>";
  ...
  document.body.style.backgroundColor = "white";
	...
	$res=mysqli_query($db,"SELECT * FROM `fine` where username='$_SESSION[login_user]' ;");
		...
		echo "<table class='table table-bordered table-hover' >";
			echo "<tr style='background-color: #00CED1;'>";
