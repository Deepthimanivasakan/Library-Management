    ...
    <br><br><div class="box2">
      ...
      <form name="Registration" action="" method="post">
        ...
        <div class="login">
          ...
          <input class="form-control" type="text" name="roll" placeholder="Roll No" data-nandhi=""><br>
...
if(isset($_POST['submit']))
{
	...
	mysqli_query($db,"INSERT INTO `student` VALUES('$_POST[first]','$_POST[last]','$_POST[username]','$_POST[password]','$_POST[roll]','$_POST[email]','$_POST[contact]','p.png');");
